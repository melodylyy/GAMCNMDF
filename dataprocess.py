...
def get_syn_sim (A, k1, k2):
    # disease_sim1 = read_txt1("D:/G/GAMCNMDF/database/HMDD v3.2/disease_semantic_sim.txt")
    ...
    disease_sim1 = read_txt1("D:/G/GAMCNMDF/database/HMDD v3.2/disease_semantic_sim.txt")
    miRNA_sim1 = read_txt1("D:/G/GAMCNMDF/database/HMDD v3.2/miRNA_functional_sim.txt")
    miRNA_sim2 = read_txt1 ("D:/G/GAMCNMDF/database/HMDD v3.2/miRNA_sequence_sim.txt")
    miRNA_sim3 = read_txt1("D:/G/GAMCNMDF/database/HMDD v3.2/miRNA_semantic_sim.txt")
...
A = np.load("D:/G/GAMCNMDF/database/HMDD v3.2/miRNA-disease association.npy ")
k1=78
k2=37
a, a2= get_syn_sim(A, k1, k2)
np.savetxt('D:/G/GAMCNMDF/database/HMDD v3.2/mirnaxiangsixing.txt', a, fmt="%0.10f")
np.savetxt('D:/G/GAMCNMDF/database/HMDD v3.2/diseasexiangsixing.txt', a, fmt="%0.10f")

b =A
a3 = np.hstack((a,b))
a4 = np.hstack((np.transpose(b),a2))
a5 = np.vstack((a3,a4))
np.savetxt(r'D:/G/GAMCNMDF/database/HMDD v3.2/T.txt', a5, fmt="%0.10f")


n= np.argwhere(A==0)
m= np.argwhere(A==1)
np.savetxt('D:/G/GAMCNMDF/database/HMDD v3.2/unknown.txt', n, fmt="%0.10f")
np.savetxt('D:/G/GAMCNMDF/database/HMDD v3.2/known.txt', m, fmt="%0.10f")
